...
<template>
    ...
    <div>
        <div class="flex flex-col items-center">
            ...
            <div class="bg-[#ffffff98] rounded-box w-fit shadow-lg py-4 px-10 mb-4">
                <h1 class="text-black/70 text-3xl font-bold drop-shadow-lg">{{ roomName }}</h1>
            </div>
                ...
                <fieldset class="fieldset bg-[#ffffff98] rounded-box w-fit shadow-lg border my-6 p-4">
                    ...
                    <div class="form-control w-full">
                        ...
                        <div v-else class="mx-auto w-fit">
                            <button @click="handleSubmitImport"
                                class="btn h-fit bg-gradient-to-t from-[#ff8f00] to-[#ffd902] p-2 mt-4 border-0 rounded-[2rem] text-white">
                                <div class="bg-[#ffae02] px-6 py-3 rounded-[2rem] text-lg font-semibold">
                                    <p class="drop-shadow-lg">เริ่มจับฉลาก</p>
                                </div>
                            </button>
