    ...
    <div>
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-col justify-center items-center">
                <fieldset
                    class="fieldset bg-[#ffffff98] rounded-box w-full max-w-2xl shadow-lg border my-6 p-4 mx-4 sm:mx-auto">
                    ...
                    <div class="form-control w-full space-y-4">
                        ...
                        <!-- Input file -->
                        <label
                            class="flex items-center justify-between bg-white border-none rounded-[1.5rem] px-4 py-2 w-full cursor-pointer text-black">
                            <span class="truncate">
