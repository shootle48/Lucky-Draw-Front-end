<template>
    <div class="p-6 space-y-6">
        <h1 class="text-3xl font-bold ju">Summary of the Dashboard</h1>
        ...
        <div v-else>
            <!-- Winners Section -->
            <div>
                <h2 class="text-2xl font-semibold mb-2">🏆 ผู้ที่ได้รางวัล</h2>
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div v-for="winner in dashboard.winners" :key="winner.id"
                        class="card bg-base-100 fill-gray-500 drop-shadow-lg drop-shadow-gray-500/50 hover:bg-black/50">
                        ...
                        <div class="card-body flex items-center lg:p-0 max-w-[400px] mx-auto">
                            ...
                            <div class="p">
                                ...
                                <div class="flex flex-col items-start p-1">
                                    ...
                                    <span class="badge badge-ghost h-full px-4 text-left">
                                        {{
                                ...
                                <!-- Active -->
                                <div class="flex flex-col items-start p-1">
                                    <span class="font-semibold">ผู้เข้าร่วม </span>
                                ...
                                <!-- Qty & Time -->
                                <div class="flex flex-col items-start p-1">
                                    <span class="font-semibold">จำนวนรอบที่สุ่ม</span>
                                    <span class="badge badge-outline h-full px-4 text-left">
                                        {{ winner.quantity }}
                                    </span>
                                </div>
            ...
            <!-- Prizes Section -->
            <div>
                <h2 class="text-2xl font-semibold mb-2 mt-10">🎁 รางวัลที่เหลือ</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div v-for="prize in dashboard.prizes" :key="prize.id"
                        class="card bg-base-100 shadow-md hover:shadow-xl fill-gray-500 drop-shadow-lg drop-shadow-gray-500/50 hover:bg-black/50">
                        <figure class="aspect-video overflow-hidden mt-5">
                        ...
                        <div class="card-body flex items-center justify-center text-center">
                            <h3 class="card-title truncate text-lg">{{ prize.name }}</h3>
                            <p class="text-sm text-gray-600">🎁 Remaining: {{ prize.quantity }}</p>
                        </div>
                    </div>
                </div>
            </div>
