...
<template>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    <div v-for="prize in prizes" :key="prize.id" class="card bg-base-200 shadow-sm hover:shadow-md transition-shadow duration-200 relative overflow-hidden">
      <!-- ปุ่มลบรางวัล -->
      <button @click="" class="absolute top-2 right-2 btn btn-sm btn-circle btn-error z-10">
