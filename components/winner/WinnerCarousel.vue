    ...
    <div v-if="type === 'winner'" class="card bg-white/60 drop-shadow-lg hover:bg-white/50 md:min-w-70">
      ...
      <div class="card-body flex items-center flex-col text-center max-w-[300px] mx-auto">
        ...
        <button @click="$emit('show-detail', item)"
          class="btn h-fit bg-gradient-to-t from-[#00B2FF] to-[#88E2FF] p-0.5 px-1.5 py-1.5 border-0 rounded-[2rem]  text-white shadow-black shadow-sm">
          <div class="bg-[#00B2FF] rounded-[2rem] p-0.25 px-2.5 text-sm md:text-lg font-medium flex items-center gap-1">
